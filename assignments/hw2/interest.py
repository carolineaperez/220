...
Name: Caroline Perez
interest.py
Problem: this program calculated the interest rate

Certify og Authenticity:
...
def main():
    ...
    day_the_payment_was_made = eval(input('day of the billing cycle the payment was made:'))
