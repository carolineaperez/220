...
Problem: makes a program that does the same thing as bumper cars
...
def hit_vertical(circle1, window):
    centerpoint = circle1.getCenter()
    center_x = centerpoint.getX()
...
def hit_horizontal(ball, win):
    ...
    center_point_y = centerpoint.getY()
...
def get_random_color():
    ...
    green = randint(0, 255)
    blue = randint(0, 255)
    return color_rgb(rojo, green, blue)
