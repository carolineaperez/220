...
def writeSumOfSquares():
    file_name = input("Enter the input file: ")
...
def starter():
    ...
    number_wins = float(input("Enter the number of wins: "))
    if 150 <= weight <= 160 and number_wins >= 5:
        print("The player would be a starter")
    elif weight > 199 or number_wins > 20:
        print("The player would be a starter")
    else:
